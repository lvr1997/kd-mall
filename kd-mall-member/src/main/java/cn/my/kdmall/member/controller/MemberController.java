...
import cn.my.kdmall.member.feign.CouponFeignService;
...
import cn.my.kdmall.member.service.MemberService;
...
public class MemberController {
    ...
    public R testquerycoupon() {
        MemberEntity memberEntity = new MemberEntity();
        memberEntity.setNickname("测试用户");
        R coupons =  couponFeignService.couponXinxi();
